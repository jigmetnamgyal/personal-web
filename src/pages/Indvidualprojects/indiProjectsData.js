...
import thrivingArtists from '../../assets/thrivingArtists/thrivingartists.png';
import thriv from '../../assets/thrivingArtists/thriv.png';
...
export const indiProjectsData = [
    {
        ...
        "firstName": ["A", "r"],
        "lastName": ["E", "x", "p"],
        "images": [arexp, frontImg, heartImg, drukCoin, one, two, three, four, five, six],
        "awardImgs": [cert1, BIG],
        "certInfo":["ArExp idea awarded 3rd in a start up competition (1000$) held by ADA University and sponsored by British Council. Creative Spark Big Idea Challenge is the British Council’s 60-second video pitching competition designed to teach the basics of entrepreneurship and how to develop an idea from concept to reality. This competition is for young people aged between 18 and 35, citizen of Armenia, Azerbaijan, Georgia, Kazakhstan, Kyrgyzstan, Ukraine or Uzbekistan and associated with a Creative Spark partner institutions. It is for individuals as well as teams of up to four members, for those who already have a big idea or want to learn how to come up with one! I got the opportunity to participate in this challenge since I study in ADA University in Azerbaijan", "ArExp idea got shortlisted in Top 20 in BIG_2021 International start-up competition. The idea got selected amongst 280+ startup around the world. The result of the final pitch will be announced on first week of May 2021 (Eagerly waiting), where we are competing for the grand prize of 100K$. For your info BIG is a an initiative under iDEA project that aims to build a Startup Ecosystem in Bangladesh but Foreign startups will be able to participate through an international roadshow. Through “BIG” young entrepreneurs i.e. new innovative ideas of startups will be encouraged to build a startup ecosystem in the country and establish this event as a flagship program at the international level."],
        "type": "Start-up Idea",
    ...
    {
        "id":1,
        "firstName": ["T","h","r","i","v", "i", "n", "g"],
        "lastName": ["A", "r", "t", "i", "s", "t"],
